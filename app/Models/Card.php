...
class Card extends Model
{
    ...
    public function toSearchableArray(): array
    {
        ...
        return [
            ...
            'token'                                          => $this->token,
            'thumbnail'                                      => $this->properties ? $this->properties->get('images_thumbnail') : null,
            'thumbnail_width'                                => $this->properties ? $this->properties->get('images_thumbnail_width') : null,
            'thumbnail_height'                               => $this->properties ? $this->properties->get('images_thumbnail_height') : null,
            'screenshot_thumbnail'                           => $this->properties ? $this->properties->get('screenshots_thumbnail') : null,
            'screenshot_thumbnail_width'                     => $this->properties ? $this->properties->get('screenshots_thumbnail_width') : null,
            'screenshot_thumbnail_height'                    => $this->properties ? $this->properties->get('screenshots_thumbnail_height') : null,
