...
{
    public function testDecodesFiltersCorrectly()
    {
    ...
    public function testEmptyFilterStringsReturnEmptyArray()
    {
        $filterString = '';
        $decoder = new FilterDecoder($filterString);
    ...
    public function testDecodingAndReturningAppliedFiltersForRequest()
    {
