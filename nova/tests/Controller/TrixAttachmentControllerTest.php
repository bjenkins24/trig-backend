...
class TrixAttachmentControllerTest extends IntegrationTest
{
    ...
    public function testAddingTrixAttachmentsToFields()
    {
    ...
    public function testRemovingTrixAttachments()
    {
        $user = factory(User::class)->create();
        $draftId = Uuid::uuid();
    ...
    public function testDeletingResourceWithTrixFieldDeletesAttachments()
    {
        $user = factory(User::class)->create();
        $draftId = Uuid::uuid();
