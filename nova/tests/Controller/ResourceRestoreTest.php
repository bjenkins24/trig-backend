...
class ResourceRestoreTest extends IntegrationTest
{
    ...
    public function testCanRestoreResources()
    {
    ...
    public function testCanRestoreResourcesViaSearch()
    {
        $user = factory(User::class)->create();
        $user2 = factory(User::class)->create();
    ...
    public function testCanRestoreResourcesViaFilters()
    {
        $user = factory(User::class)->create();
        $user2 = factory(User::class)->create();
    ...
    public function testCantRestoreResourcesNotAuthorizedToRestore()
    {
        $user = factory(User::class)->create();
        $user2 = factory(User::class)->create();
    ...
    public function testActionEventShouldHonorCustomPolymorphicTypeWhenRestoringResource()
    {
    ...
    public function testShouldStoreActionEventOnCorrectConnectionWhenRestoring()
    {
