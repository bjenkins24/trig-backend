...
class LensResourceCountTest extends IntegrationTest
{
    ...
    public function testCanCountAResource()
    {
    ...
    public function testCanCountAResourceViaFilter()
    {
        factory(User::class)->create();
        factory(User::class)->create();
        factory(User::class)->create();
    ...
    public function testCanCountAResourceWithGrouping()
    {
    ...
    public function testCanCountAResourceWithHaving()
    {
