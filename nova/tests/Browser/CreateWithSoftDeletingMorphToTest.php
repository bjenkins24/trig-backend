...
class CreateWithSoftDeletingMorphToTest extends DuskTestCase
{
     ...
     * @test
     */
    public function testParentSelectIsLockedWhenCreatingChildOfSoftDeletedNonSearchableResource()
    {
     ...
     * @test
     */
    public function testParentSelectIsLockedWhenCreatingChildOfSoftDeletedSearchableResource()
    {
     ...
     * @test
     */
    public function nonSearchableMorphToRespectsWithTrashedCheckboxState()
    {
        $this->setupLaravel();
