...
class GoogleIntegrationTest extends TestCase
{
     ...
     */
    public function testSyncCardsContinue(): void
    {
        [$user] = $this->getSetup();
        $file = new FileFake();
        $file->name = 'My cool title';
        ...
        $this->partialMock(GoogleIntegration::class, static function ($mock) use ($file, $nextPageToken) {
        ...
        app(OauthIntegrationService::class)->makeSyncCards('google')->syncCards($user);
    ...
    public function testGetFiles(): void
    {
        ...
        $user = User::find(1);
        $this->createOauthConnection($user);
        $this->mock(GoogleConnection::class);
