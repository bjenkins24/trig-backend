...
//        $expectedCleaned = <<<HTML
    //<p>On Deck “</p><p>On Deck ‘</p><p>Founder Questionnaire: Self-Reflection</p><p>As you begin the early stages of idea exploration or seeking out co-founders, we suggest you invest time in better understanding yourself and your goals.</p><p>This self-reflection exercise will inform which ideas you may choose to pursue (i.e.those you have “Founder Market Fit” with), and the other roles you'll need to add to your founding team.</p>Objectives of this exercise:<br />
    //<ul><li>Increase self-awareness<ul><li>Learn about yourself: what are your motivations, fears, unique edges.</li></ul></li><li>Define your goals<ul><li>What kind of business do you want to build? What lifestyle, financial, and risk tradeoffs do you want to optimize for?</li></ul></li><li>Align on values<ul><li>Determine whether you agree on first principles with prospective co-founders</li></ul></li><li>Identify your critical risks<ul><li>What gaps do you have on your founding team that are existential to your success?</li></ul></li><li>Be vulnerable and honest with each other<ul><li>Understanding motivations, fears, and working styles is critical to working together effectively and building trust quickly. This guide can serve as a tool for easing into those conversations.</li></ul></li><li>Highlight what roles you need on your founding team<ul><li>Developing an understanding of your collective weak spots can be useful for both making those early hires to add to your team and for identifying your own personal areas of growth.</li></ul></li></ul><p>On Deck</p><p>Ikigai: the pursuit of purpose</p><p>There’s a Japanese concept called Jkigai. It refers to finding a direction or purpose in life, that which makes one's life worthwhile, and towards which an individual takes spontaneous and willing actions giving them satisfaction and a sense of meaning to life. Ikigai comes at the intersection of four things: what you’re good at, what can make you money, what the world needs, and what you’re passionate about. For example, your passion lies at the intersection of what you’re good at, and what you love.</p><p>It's possible to spreadsheet this out, list all the things you’ve ever thought about doing and score</p><p>them on these four axes. For example, if there’s two things that you’re neutral on, but one of them pays more than the other, or it’s something the world needs, you may choose that one.</p><p>Try listing these below, and ranking them FINDING YOUR IKIGAI</p><p>1. What do you love?</p><p>a. Product WHAT | LOVE b. Marketing c. Analytics d. Technology e. Programming wearin z WORLD NEEDS f. Music 2. What does the world need? WHAT | CAN</p><p>BE PAID FOR</p><p>3. What can you be paid for?</p><p>4. What are you good at?</p>
    //HTML;
//        $filename = 'sup.png';
//
